...
Para comprobar el correcto funcionamiento del servicio API DISCOVER, se utilizaran un conjunto de 5 RDF's en formato xml que estan disponibles en [este enlance](https://github.com/HerculesCRUE/GnossDeustoBackend/blob/master/API_DISCOVER/xml_descubrimiento.zip).

Realizaremos las pruebas accediendo con el método /etl/data-publish, podemos probar el mismo desde Swagger siguiendo estos pasos:
...
Comprobamos que se ha realizado correctamente el descubrimiento buscando tanto a Diego López de Ipiña como a Diego Casado-Mansilla, nos aparecerán ambos con su información correspondiente.
...
Si queremos eliminar los datos subidos en estas pruebas, hay que ejecutar las siguiente sentencias en virtuoso:
