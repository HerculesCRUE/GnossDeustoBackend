...
system which is capable of handling RDF[1](#rdf-spec) data, either natively or
not, and to query the data using the SPARQL query language and
protocol[2](#sparql-spec). A number of benchmark studies have been conducted in the
