...
namespace XUnit_LinkedData
{
    public class UnitTest1
    {
        ...
        public void TestSearch()
        {
            ...
            var result4 = x.GenerateSearchTemplate("", "", "", "http://purl.org/roh/mirror/bibo#AcademicArticle", 1);
            Assert.True(result.entidades.Count > 0 && result2.entidades.Count > 0 && result3.entidades.Count > 0 && result4.entidades.Count > 0);
        }
    }
}
