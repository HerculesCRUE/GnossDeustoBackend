...
Éste es el repositorio del proyecto Hércules ASIO en el que se incluiyen los siguientes programas y servicios
 ...
 - [Api_Carga_Client](https://github.com/HerculesCRUE/GnossDeustoBackend/tree/master/Api_Carga_Client "Api_Carga_Client"): Interfaz web para la parte de Repository y Validation del API_CARGA
